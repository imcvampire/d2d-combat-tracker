...
import { User, Skull, Shield, Crown } from 'lucide-react';
        ...
        return (
          <motion.div
            ...
            className={cn(
              ...
              isActive && "border-magenta shadow-glowMagenta",
          ...
          >
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="flex-1">
                ...
                <div className="mt-2">
                  <Progress value={hpPercentage} className="h-3 bg-gray-700" indicatorClassName={cn(hpPercentage > 50 ? "bg-cyan" : hpPercentage > 20 ? "bg-yellow-500" : "bg-magenta")} />
